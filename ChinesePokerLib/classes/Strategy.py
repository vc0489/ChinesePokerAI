...
from ChinesePokerLib.classes.Exception import StrategyIDUsedError
...
class ChinesePokerStrategy():
  ...
  def __init__(
    ...
    if split_gen_filter_by_score and split_gen_filter_strategy is None:
      split_gen_filter_strategy = ChinesePokerPctileScoreStrategy(split_gen_filter_by_score=False)
    ...
    if split_pick_filter_by_score and split_pick_filter_strategy is None:
      split_pick_filter_strategy = ChinesePokerPctileScoreStrategy()
...
class ChinesePokerPctileScoreStrategy(ChinesePokerStrategy):
...
class ChinesePokerModelSetToGameScoreStrategy(ChinesePokerStrategy):
  """
